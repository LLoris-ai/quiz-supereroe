...
export const PROFILI = [
  ...
  },
  {
    ...
    colore: '#8a1620',
    descrizione:
      'Leader riconosciuta e apprezzata dal team, unisce intelligenza analitica a una spiccata sensibilità verso le persone. Gestisce responsabilità importanti con metodo, non si lascia deviare dai dettagli e valorizza il potenziale dei collaboratori anche nelle situazioni di disaccordo.',
  ...
  },
  {
    ...
    colore: '#b3341c',
    descrizione:
      'Profilo brillante e comunicativo, si muove con sicurezza in contesti dinamici e innovativi. Generoso nel condividere competenze e risorse, non si arrende davanti agli ostacoli; la personalità decisa richiede un ambiente capace di apprezzarne il valore, ma chi lavora con lui costruisce rapporti duraturi.',
